...
namespace Playnite.WebView
{
    public class WebView : WebViewBase, IWebView
    {
        ...
        private void Browser_TitleChanged(object sender, DependencyPropertyChangedEventArgs args)
        {
            ...
            var titleSuffix = ResourceProvider.GetString("LOCAppName");
            if (titleSuffix.StartsWith("<!", StringComparison.Ordinal) && titleSuffix.EndsWith("!>", StringComparison.Ordinal))
            {
                titleSuffix = "ETPlayer";
            }
