...
namespace Playnite.DesktopApp.ViewModels
{
    public class DesignMainViewModel : DesktopAppViewModel
    {
        ...
        public DesignMainViewModel() : base(new InMemoryGameDatabase(), null, null, new ResourceProvider(), null)
        {
            ...
            designGame.CoverImage = "pack://application:,,,/ETPlayer;component/Resources/Images/DesignCover.jpg";
            designGame.BackgroundImage = "pack://application:,,,/ETPlayer;component/Resources/Images/DesignBackground.jpg";
            designGame.Icon = "pack://application:,,,/ETPlayer;component/Resources/Images/DesignIcon.png";
