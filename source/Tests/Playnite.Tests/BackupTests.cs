    ...
    public class BackupTests
    {
        ...
        public void RotatingBackupTest()
        {
            using (var temp = TempDirectory.Create())
            {
                ...
                {
                    FileSystem.CreateFile(Path.Combine(temp.TempPath, "ETPlayerBackup-2021-07-01-01-01-01.zip"));
                    FileSystem.CreateFile(Path.Combine(temp.TempPath, "ETPlayerBackup-2021-07-02-01-01-01.zip"));
                    FileSystem.CreateFile(Path.Combine(temp.TempPath, "ETPlayerBackup-2021-07-03-01-01-01.zip"));
                }
