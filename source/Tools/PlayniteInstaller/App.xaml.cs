...
namespace PlayniteInstaller
{
    ...
    public partial class App : Application
    {
        ...
        public static string TempDir => Path.Combine(Path.GetTempPath(), "ETPlayerInstaller");
        public static string InstallerDownloadPath => Path.Combine(Path.GetTempPath(), "ETPlayerInstaller", "installer.exe");
